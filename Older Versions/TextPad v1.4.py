...
file.add_separator()
file.add_command(label='Exit', command=leave)
edit = tk.Menu(menubar, tearoff=0)
menubar.add_cascade(label='Edit', menu=edit)
edit.add_command(label='Copy', command=copyup)
edit.add_command(label='Paste', command=pasteup)
edit.add_command(label='Select All', command=selectall)
edit.add_command(label='Find...', command=showfind)
options = tk.Menu(menubar, tearoff=0)
menubar.add_cascade(label='Options', menu=options)
options.add_command(label='Toggle Dark Mode', command=toggle_dm)
options.add_command(label='Toggle Fullscreen Mode', command=toggle_fs)
