...
btn_dm = ttk.Button(fr_buttons, text="Toggle Dark Mode", command=toggle_dm)
btn_find = ttk.Button(fr_buttons, text="Find", command=showfind)
btn_about = ttk.Button(fr_buttons, text="About", command=showinfo)
btn_exit = ttk.Button(fr_buttons, text="Exit", command=leave)
btn_open.grid(row=0, column=0, sticky="ew", padx=5, pady=5)
btn_save.grid(row=1, column=0, sticky="ew", padx=5,)
btn_dm.grid(row=2, column=0, sticky="ew", padx=5, pady=5)
btn_find.grid(row=3, column=0, sticky="ew", padx=5)
btn_about.grid(row=4, column=0, sticky="ew", padx=5, pady=5)
btn_exit.grid(row=5, column=0, sticky="ew", padx=5)
