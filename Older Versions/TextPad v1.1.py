...
def showinfo():
    ...
    version = tk.Label(about, text="Version 1.1", bg="white")
...
btn_about = tk.Button(fr_buttons, text="About", command=showinfo)
...
btn_about.grid(row=3, column=0, sticky="ew", padx=5)
